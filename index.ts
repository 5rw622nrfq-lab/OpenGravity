...
export async function runAgentLoop(userMessage: string): Promise<string> {
    ...
    while (iterations < MAX_ITERATIONS) {
        ...
        const systemPrompt: ChatMessage = {
            role: 'system',
            content: "Eres OpenGravity, un agente de IA personal que se ejecuta localmente a través de Telegram. Responde SIEMRE en el idioma que te hable el usuario (español o inglés). Sé conciso y servicial. Usa herramientas cuando sea necesario."
        };
